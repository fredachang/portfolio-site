  ...
  return (
    <>
      <div
        ...
        className={`bg-white flex flex-col md:flex-row w-full h-full md:h-6/8 md:px-2 md:py-6 overflow-scroll`}
      >
        {isMobile ? (
        ...
        <div className="md:w-full flex h-full flex-col md:flex-row relative">
          ...
          >
            ...
            <div>
              ...
              >
                <p className="text-xs mt-2 px-10 md:px-0 md:mt-0 mb-20 md:mb-0 md:text-xs font-mono leading-4 md:leading-4">{`Image[${
