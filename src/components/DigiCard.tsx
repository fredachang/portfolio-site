...
Command: npx gltfjsx@6.1.4 DigiCard.glb --transform --types
*/
...
export function DigiCard(props: any) {
  const { nodes, materials } = useGLTF(
    "/DigiCard-transformed.glb"
  ) as GLTFResult;
...
useGLTF.preload("/DigiCard-transformed.glb");
